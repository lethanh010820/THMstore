<%-- 
    Document   : cart_1
    Created on : Mar 24, 2021, 7:44:01 PM
    Author     : asus
--%>
				...
				<div class="row">
								...
								<tbody>	
									...
									<tr>
										<td class="cart-product">
											<a href="#"><img alt="Blouse" src="${o.productImage}"></a>
										</td>
										<td class="cart-description">
											<p class="product-name"><a href="#">${o.productName}</a></p>
										...
										<td class="cart-unit">
											<ul class="price text-right">
												<li class="price">${o.productPrice}</li>
											</ul>
										</td>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="returne-continue-shop">
							...
							<a href="checkout-signin.jsp" class="procedtocheckout">Proceed to checkout<i class="fa fa-chevron-right"></i></a>
						</div>	
