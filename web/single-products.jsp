			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="bstore-breadcrumb">
							...
							<a href="shop-yoga.jsp"> ĐỒ TẬP YOGA </a>
				...
				<div class="row">
					<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
						...
						<div class="row">
							<div class="col-lg-5 col-md-5 col-sm-4 col-xs-12">
								<div class="single-products-view">
									  <!-- Tab panes -->
									<div class="tab-content">
										<div class="tab-pane active" id="thumbnail_1">
											<div class="single-products-image">
												<img src="img/product/sale/yo1.jpg" alt="single-products-image" />
												<a class="new-mark-box" href="#">new</a>
												<a class="fancybox" href="img/product/sale/yo1.jpg" data-fancybox-group="gallery"><span class="btn large-btn">View larger <i class="fa fa-search-plus"></i></span></a>
											</div>
										</div>
									</div>										
								</div>
								<div class="select-product">
									...
									<ul class="nav nav-tabs select-product-tab bxslider">
										<li class="active">
											<a href="#thumbnail_1" data-toggle="tab"><img src="img/product/sale/yo1.jpg" alt="pro-thumbnail" /></a>
										</li>
									</ul>										
								</div>
							</div>
							<div class="col-lg-7 col-md-7 col-sm-8 col-xs-12">
								<div class="single-products-descirption">
									<h2>Bra 360s Farewell màu hồng</h2>
									<div class="single-products-social-share">
										<ul>
									...
									<div class="single-products-review-box">
									...
									<div class="single-products-condition">
									...
									<div class="single-products-quantity">
									...
									<div class="single-products-size">
									...
									<div class="single-products-add-cart">
										<a class="add-cart-text" title="Add to cart" href="#">Thêm vào giỏ hàng</a>
									</div>
								</div>
							</div>
						</div>
						<!-- SINGLE-PRODUCTS-DESCRIPTION END -->
						<!-- SINGLE-PRODUCTS INFO TAB START -->
						<div class="row">
							<div class="col-sm-12">
					...
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
						...
						<!-- SINGLE SIDE BAR END -->
						<!-- SINGLE SIDE BAR START -->						
						<div class="single-products-right-sidebar">
